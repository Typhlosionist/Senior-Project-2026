...
public class DungeonGenerator : MonoBehaviour
{
    ...
    private HashSet<Vector2Int> ConnectRooms(List<Vector2Int> roomPositions)
    {
        ...
        while (unconnectedRooms.Count > 0)
        {
            ...
            hallways.UnionWith(CreateCorridor(closestConnectedRoom, currentRoom)); 
            ...
            if (additionalConnections > 0 && connectedRooms.Count > 1)
            {
                for (int i = 0; i < additionalConnections; i++)
                {
                    ...
                    {
                        hallways.UnionWith(CreateCorridor(randomRoom, currentRoom));
                    }
                }
            }
    ...
    private IEnumerable<Vector2Int> CreateCorridor(Vector2Int closestConnectedRoom, Vector2Int destination)
    {
